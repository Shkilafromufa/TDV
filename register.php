...
if (!password_verify($confirm_password, $password)) {
    ...
    // Регистрируем пользователя и перенаправляем на страницу личного кабинета
...
<link rel="stylesheet" href="Главная.css" media="screen">
 ...
 <h2>Регистрация</h2>
   <form method="post">
    ...
    <div class="g-recaptcha" data-sitekey="6LeUg_8pAAAAAEvMj27AjuoA1Es2rh4ri4DjEiqg" style="display: flex; justify-content: center; margin: auto;"> </div> <br>
    <input type="submit" value="Регистрация"style="display: flex; justify-content: center; margin: auto; width: -webkit-fill-available;">
</form>
