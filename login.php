...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        // Если данные верны, авторизуем пользователя и перенаправляем на соответствующую страницу в зависимости от роли
...
<link rel="stylesheet" href="Главная.css" media="screen">
  ...
  <form method="post" class="loginform">
    ...
    <input type="submit" value="Войти" style="display: flex; justify-content: center; margin: auto; width: -webkit-fill-available;">
</form>

    <p>У вас нет аккаунта? <a href="register">Регистрация</a></p>
    <p>Забыли пароль? <a href="recovery">Восстановление пароля</a></p>
     <style>
