...
// Проверка, был ли отправлен запрос на обновление значения actual
if (isset($_POST['id']) && isset($_POST['actual'])) {
    // Получение данных из запроса
    $id = $_POST['id'];
    $actual = $_POST['actual'];

    // Обновление значения actual в базе данных
    $stmt = $pdo->prepare('UPDATE reviews SET actual = ? WHERE id = ?');
...
<link rel="stylesheet" href="Главная.css" media="screen">
    ...
    <link id="u-theme-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i">
        ...
        <script class="u-script" type="text/javascript" src="adminscript.js" defer=""></script>  
...
<br>
  ...
  <ul>
    <li title="Производимые товары"><label for="tab1" role="button">Производимые товары</label></li>
    <li title="Предлагаемые услуги"><label for="tab2" role="button">Предлагаемые услуги</label></li>
  </ul>
  <div class="slider"></div>
  <div class="content">
    <section id="products">
      <div class="column">
        <!-- Здесь будут отображаться производимые товары в первом столбце -->
      </div>
      <div class="column">
        <!-- Здесь будут отображаться производимые товары во втором столбце -->
      </div>
    </section>
    <section id="services">
      <div class="column">
        <!-- Здесь будут отображаться предлагаемые услуги в первом столбце -->
      </div>
      <div class="column">
        <!-- Здесь будут отображаться предлагаемые услуги во втором столбце -->
      </div>
    </section>
  </div>
</div>
  ...
  <div style="flex: 1;">
            <br>
 <form action="create_unit" method="post" enctype="multipart/form-data" id="adminForm" class="my-form">
  <div>
<label>
  <input type="radio" name="category_id" value="1" checked> Товар
</label>
<label>
  <input type="radio" name="category_id" value="2"> Услуга
</label>
  </div>
  <div>
